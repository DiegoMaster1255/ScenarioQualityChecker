...
public class ScenariuszGlowny implements Visitable{
    ...
    /**
     * Akceptacja Wizytatora w Scenariuszu Glownym
     * @param visitor
     */
    ...
    public int ileSlowWScenariuszu() {
        int ileSlow = 0;
        for(int i = 0; i<listaScenariuszy.size(); i++) {
            ileSlow += listaScenariuszy.get(i).ileSlowWPodscenariuszu();
        }
        return ileSlow;
    }
    ...
    public List<String> listaKrokowZAktorem(String aktor) {
        ArrayList<String> listaZKrokami = new ArrayList<String>();
        for (int i = 0; i < listaScenariuszy.size(); i++) {
            for (int j = 0; j < listaScenariuszy.get(i).listaKrokow.size(); j++) {
                System.out.println(listaScenariuszy.get(i).listaKrokow.get(j).getAktor());
                if(listaScenariuszy.get(i).listaKrokow.get(j).getAktor().equalsIgnoreCase(aktor)) {
                    listaZKrokami.add(listaScenariuszy.get(i).listaKrokow.get(j).wiersz);
                }
            }
        }
        return listaZKrokami;
    }
    ...
    public List<String> listaKrokowZKluczem(String klucz) {
        ArrayList<String> listaZKrokami = new ArrayList<String>();
        for (int i = 0; i < listaScenariuszy.size(); i++) {
            if(listaScenariuszy.get(i).slowoKlucz.equalsIgnoreCase(klucz)) {
                listaZKrokami.add(listaScenariuszy.get(i).listaKrokow.get((listaScenariuszy.get(i).listaKrokow.size()-1)).wiersz);
            }
        }
        return listaZKrokami;
    }
